...
function App() {
  ...
  return (
    <div style={{ fontFamily: 'Segoe UI, Roboto, Helvetica, Arial, sans-serif', padding: '24px', backgroundColor: '#f1f5f9', minHeight: '100vh', color: '#1e293b' }}>
      ...
      {/* HEADER */}
      <header style={{ backgroundColor: '#b0c5f6', color: 'white', padding: '24px', borderRadius: '16px', marginBottom: '24px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h1 style={{ margin: 0, fontSize: '26px', fontWeight: '700' }}>🚀 OperationsFlow</h1>
            <p style={{ margin: '4px 0 0 0', opacity: 0.8, fontSize: '14px' }}> Live Workflow Automation, Performance Metrics & PMO Dashboard</p>
          </div>
